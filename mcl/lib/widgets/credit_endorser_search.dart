...
class EndorserSearchRefresh extends StatefulWidget {
  final Function addTx;

  EndorserSearchRefresh(this.addTx);

  @override
  _EndorserSearchRefreshState createState() => _EndorserSearchRefreshState();
}

class _EndorserSearchRefreshState extends State<EndorserSearchRefresh> {
