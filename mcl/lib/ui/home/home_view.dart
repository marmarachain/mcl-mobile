        ...
        appBarWidget: [
          TextButton.icon(
            onPressed: () {
              ...
              context.setLocale(
                  context.supportedLocales[model.selectedLanguage()]);
              model.languageChange();
            },
            icon: Icon(Icons.language),
            label: Text(context.locale.toString()),
          ...
          // PopupMenuButton(
          //   icon: Icon(Icons.language),
          //   onSelected: (String dil) async {
          //     if (model.popMenuLanguage[0] == dil) {
          //       context.setLocale(context.supportedLocales[1]);
          //     } else if (model.popMenuLanguage[1] == dil) {
          //       context.setLocale(context.supportedLocales[0]);
          //     } else if (model.popMenuLanguage[2] == dil) {
          //       context.setLocale(context.supportedLocales[2]);
          //     }
          //     // await model.selectPopMenuLang();
          //   },
